...
export class StudentsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.studentsService.getAll(this.groupId).subscribe(
      data => {
        this.students = data;
        ...
        this.testNamesService.getAll(this.groupId, this.techDirect)
          .subscribe(data => {
              console.log(data);
              this.tests = data;
            },
    ...
    this.userService.getAll(this.groupId)
      .subscribe(
        data => {
          this.users = data;
          console.log(data);
  ...
  acceptUsersClick() {
    this.studentsService
      .addUsers(this.selectedUsers.map(user => user.id), this.groupId)
      .subscribe(() => {
        this.students = null;
        this.selectedUsers = [];
        this.ngOnInit();
